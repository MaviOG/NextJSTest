  ...
  return (
    ...
    flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20'>
      ...
      justify-start gap-8 overflow-x-auto lg:h-[400px] xl:h-[640px]'>
        ...
        title="Kemp Menina"
        subtitle="Kočevje, Slovenia"
        peopleJoined="50+ Pridružen"/>
        <CampSite
        backgroundImage="bg-bg-img-2"
        title="Kemp Jernež"
        subtitle="Krma, Slovenia"
        peopleJoined="50+ Pridružen"
        />
      </div>
      <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
        ...
        relative w-full overflow-hidden rounded-3xl">
          ...
          capitalize text-white">
            <strong>Se počutite izgubljeni</strong> in ne poznate poti?
          </h2>
          <p className="regular-14 xl:regular-16 mt-5 text-white">
            Zaradi tesnobo plezalcev ob obisku novega plezališča in
            možnosti, da se izgubite. To je
            zakaj smo tukaj za tiste, ki želite začeti avanturo
          </p>
          <Image
          src="/quote.svg"
          alt="camp-2"
